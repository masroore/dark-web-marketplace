...
class walletRPC
{
     ...
     */
    public function __construct($host = '127.0.0.1', $port = 18083, $protocol = 'http', $user = null, $password = null)
    {
     ...
     * @param  bool  $do_not_relay     Do not relay transaction                                  (optional)
     *
     *   OR
     *
     * @return object  Example: {
    ...
    public function transfer($amount, $address = '', $payment_id = '', $mixin = 6, $account_index = 0, $subaddr_indices = '', $priority = 2, $unlock_time = 0, $do_not_relay = false)
    {
        ...
        $params = ['destinations' => $destinations, 'mixin' => $mixin, 'get_tx_key' => true, 'payment_id' => $payment_id, 'account_index' => $account_index, 'subaddr_indices' => $subaddr_indices, 'priority' => $priority, 'do_not_relay' => $do_not_relay];
    ...
    public function transfer_split($amount, $address = '', $payment_id = '', $mixin = 6, $account_index = 0, $subaddr_indices = '', $priority = 2, $unlock_time = 0, $do_not_relay = false)
    {
        ...
        $params = ['destinations' => $destinations, 'mixin' => $mixin, 'get_tx_key' => true, 'account_index' => $account_index, 'subaddr_indices' => $subaddr_indices, 'payment_id' => $payment_id, 'priority' => $priority, 'unlock_time' => $unlock_time, 'do_not_relay' => $do_not_relay];
    ...
    public function sweep_all($address, $subaddr_indices = '', $account_index = 0, $payment_id = '', $mixin = 6, $priority = 2, $below_amount = 0, $unlock_time = 0, $do_not_relay = false)
    {
        ...
        $params = ['address' => $address, 'mixin' => $mixin, 'get_tx_key' => true, 'subaddr_indices' => $subaddr_indices, 'account_index' => $account_index, 'payment_id' => $payment_id, 'priority' => $priority, 'below_amount' => $this->_transform($below_amount), 'unlock_time' => $unlock_time, 'do_not_relay' => $do_not_relay];
    ...
    public function sweep_single($key_image, $address, $payment_id = '', $mixin = 6, $priority = 2, $below_amount = 0, $unlock_time = 0, $do_not_relay = 0)
    {
        ...
        $params = ['address' => $address, 'mixin' => $mixin, 'get_tx_key' => true, 'account_index' => $account_index, 'payment_id' => $payment_id, 'priority' => $priority, 'below_amount' => $this->_transform($below_amount), 'unlock_time' => $unlock_time, 'do_not_relay' => $do_not_relay];
    ...
    public function get_bulk_payments($payment_ids, $min_block_height)
    {
        ...
        $params = ['min_block_height' => $min_block_height]; // does not work
        $params = [];
    ...
    */
     ...
     * @param  bool  $do_background_mining  Mine in background?
     * @param  bool  $ignore_battery        Ignore battery?
     *
     * @return none
     */
