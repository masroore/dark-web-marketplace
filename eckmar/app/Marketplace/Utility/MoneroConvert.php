...
class MoneroConvert
{
    public const API_URL = 'https://min-api.cryptocompare.com/data/price?fsym=XMR&tsyms=EUR';
    public const API_URL_USD = 'https://min-api.cryptocompare.com/data/price?fsym=XMR&tsyms=USD';
    public const EUR = 'EUR';
    public const USD = 'USD';
    public const XMR_TO_PICONERO = 1000000000000;
