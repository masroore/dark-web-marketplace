...
abstract class Payment
{
    ...
    {
        throw_if(
            !class_exists(BitcoinMutlisig::class) && $purchase->coin_name == 'btcm',
     ...
     */
    abstract public function balance(): float;

    /**
     * Converts from USD amount to equivalent coin amount.
     */
    abstract public function usdToCoin($usd): float;

    /**
     * Returns label of this coin.
     */
    abstract public function coinLabel(): string;
}
