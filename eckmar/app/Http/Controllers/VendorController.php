...
class VendorController extends Controller
{
    ...
    public function removeOffer($quantity, ?Product $product = null)
    {
        ...
        try {
            ...
            // new offers
                ...
                $offers = $offers->reject(fn ($offer, $keys) => $offer->quantity != $quantity);
    ...
    public function removeShipping($index, ?Product $product = null)
    {
        ...
        try {
            ...
            // for new product
                ...
                $shippingsCollection = $shippingsCollection->reject(fn ($shipping, $key) => $index == $key);
    ...
    public function removeImage($id)
    {
        ...
        try {
            if ($removingImage && $removingImage->exists()) {
                ...
                $sessionImages = $sessionImages->reject(fn ($image) => $image->id == $id);
    ...
    public function editProduct($id, $section = 'basic')
    {
        ...
        $sectionMap = [
            'delivery' => view('profile.vendor.adddelivery', [
            ...
            'digital' => view('profile.vendor.adddigital', [
