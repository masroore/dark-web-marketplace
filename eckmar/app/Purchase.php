...
class Purchase extends Model
{
    ...
    public const DEFAULT_STATE = 'purchased';
    ...
    public static function totalEarningPerCoin(): array
    {
        $total_spent = 0;
        $total_earnings_coin = [];
        foreach (self::where('state', 'delivered')->get() as $deliveredPurchase) {
    ...
    public function getPayment()
    {
        if ($this->payment == null) {
            $this->payment = app()->makeWith(Marketplace\Payment\Payment::class, ['purchase' => $this]);
        }
