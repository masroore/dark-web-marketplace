...
return [
    ...
    'monero' => [
        ...
        'port' => (int) (env('MONERO_PORT', 28091)),
    ...
    'litecoin' => [
        ...
        'port' => (int) (env('LITECOIN_PORT', 19332)),
    ...
    'bictoin_cash' => [
        ...
        'port' => (int) (env('BITCOIN_CASH_PORT', 18332)),
