...
return [
     ...
     */
    'days_complete' => (int) (env('DAYS_TO_COMPLETE_PURCHASE', 2)),

    /**
     * Messages that are older than this number of days are deleted.
     */
    'days_old_messages' => (int) (env('MESSAGES_DAYS_OLD', 30)),
     ...
     */
    'days_old_purchases' => (int) (env('PURCHASES_DAYS_OLD', 60)),
     ...
     */
    'js_warning' => (bool) (env('MARKETPLACE_JSWARNING', false)),
