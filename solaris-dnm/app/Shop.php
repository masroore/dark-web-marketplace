 ...
 * @property \App\Employee[]|\Illuminate\Database\Eloquent\Collection $employees
 *
 ...
 * @mixin \Eloquent
 *
 * @property \App\Good[]|\Illuminate\Database\Eloquent\Collection $goods
 ...
 * @property \App\EmployeesLog[]|\Illuminate\Database\Eloquent\Collection $employeesLog
 ...
 * @property \App\Page[]|\Illuminate\Database\Eloquent\Collection $pages
 * @property \App\QiwiWallet[]|\Illuminate\Database\Eloquent\Collection $qiwiWallets
 * @property string $banner_url
 * @property string $information
 * @property string $problem
 * @property int $employees_count
 * @property \App\EmployeesEarning[]|\Illuminate\Database\Eloquent\Collection $employeesEarnings
 * @property \App\EmployeesPayout[]|\Illuminate\Database\Eloquent\Collection $employeesPayouts
 *
 ...
 *
 * @property \App\QiwiExchange[]|\Illuminate\Database\Eloquent\Collection $qiwiExchanges
...
{
    use MessengerModels\Traits\Messageable;
    use Walletable;
     ...
     * @return Shop
     */
    private static $_shop;

    public static function getDefaultShop()
    {
        if (self::$_shop === null) {
            try {
                self::$_shop = self::find(1);
    ...
    /**
     * @return Builder|Employee[]|\Illuminate\Database\Eloquent\Relations\HasMany
     */
    ...
    /**
     * @return Builder|Good[]|\Illuminate\Database\Eloquent\Relations\HasMany
     */
    ...
    {
        return $this->goods()->whereHas('packages', function ($packages): void {
            $packages->where('has_quests', true);
        });
    }

    /**
     * @return Builder|\Illuminate\Database\Eloquent\Relations\HasMany|PaidService[]
     */
    ...
    /**
     * @return Builder|EmployeesLog[]|\Illuminate\Database\Eloquent\Relations\HasMany
     */
    ...
    /**
     * @return Builder|\Illuminate\Database\Eloquent\Relations\HasMany|QiwiWallet[]
     */
    ...
    /**
     * @return Builder|\Illuminate\Database\Eloquent\Relations\HasMany|QiwiExchange[]
     */
    ...
    /**
     * @return Builder|\Illuminate\Database\Eloquent\Relations\HasMany|Wallet[]
     */
    ...
    {
        return $this->wallets->filter(fn ($item) => $item->type == Wallet::TYPE_PRIMARY)->first();
    }
    ...
    {
        return $this->wallets->filter(fn ($item) => $item->type == Wallet::TYPE_ADDITIONAL);
    }
    ...
    /**
     * @return Builder|\Illuminate\Database\Eloquent\Relations\HasMany|Page[]
     */
    ...
    /**
     * @return Builder|EmployeesEarning[]|\Illuminate\Database\Eloquent\Relations\HasMany
     */
    ...
    /**
     * @return Builder|EmployeesPayout[]|\Illuminate\Database\Eloquent\Relations\HasMany
     */
    ...
    {
        $ratings = GoodsReview::select(DB::raw('count(*) as c, sum(shop_rating) as sr, sum(dropman_rating) as dr, sum(item_rating) as ir'))
            ->first()
            ->toArray();
