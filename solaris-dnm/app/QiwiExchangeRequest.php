 ...
 * @property QiwiExchangeTransaction $qiwiExchangeTransaction
 *
...
class QiwiExchangeRequest extends Model
{
    ...
    public const STATUS_PAID_REQUEST = 'paid_request';
    public const STATUS_PAID = 'paid';
    public const STATUS_PAID_PROBLEM = 'paid_problem';
    ...
    /**
     * @return Builder|\Illuminate\Database\Eloquent\Relations\BelongsTo|QiwiExchange
     */
    ...
    /**
     * @return Builder|\Illuminate\Database\Eloquent\Relations\HasOne|QiwiExchangeTransaction
     */
