...
class SystemController extends ManagementController
{
    ...
    {
        $oldDate = $this->shop->isExpired() ? Carbon::now() : $this->shop->expires_at;
    ...
    public function showPaymentsEmployeesConfirmForm(Request $request)
    {
        ...
        $newEmployeesCount = (int) ($request->get('employees_count'));
    ...
    public function integrations(Request $request)
    {
        ...
        if (null === $this->propertiesProvider->getBool(DynamicPropertiesProvider::KEY_INTEGRATION_CATALOG)) {
