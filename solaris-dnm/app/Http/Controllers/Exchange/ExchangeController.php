...
class ExchangeController extends Controller
{
    ...
    public function exchange(Request $request)
    {
        ...
        $minExchangeAmountBtc = $exchange->convertRubles($exchange->min_amount, BitcoinUtils::CURRENCY_RUB, BitcoinUtils::CURRENCY_BTC);
        $maxExchangeAmountBtc = $exchange->convertRubles($exchange->max_amount, BitcoinUtils::CURRENCY_RUB, BitcoinUtils::CURRENCY_BTC);

        $minExchangeAmountBtc = min($btcBalance, $minExchangeAmountBtc);
        $maxExchangeAmountBtc = min($btcBalance, $maxExchangeAmountBtc);

        $rubBalance = $exchange->convertRubles($btcBalance, BitcoinUtils::CURRENCY_BTC, BitcoinUtils::CURRENCY_RUB);
