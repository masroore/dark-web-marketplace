 ...
 * @mixin \Eloquent
 *
 * @property \App\AccountingDistribution[]|\Illuminate\Database\Eloquent\Collection $distributions
 * @property Good $good
...
class AccountingLot extends Model
{
    ...
    /**
     * @return AccountingDistribution[]|Builder|\Illuminate\Database\Eloquent\Relations\HasMany
     */
