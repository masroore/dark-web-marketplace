 ...
 *
 * @property Shop $user
 * @property \App\Transaction[]|\Illuminate\Database\Eloquent\Collection $transactions
...
class Wallet extends Model
{
    ...
    /**
     * @return Builder|\Illuminate\Database\Eloquent\Relations\HasMany|Transaction[]
     */
    ...
    /**
     * @return Builder|\Illuminate\Database\Eloquent\Relations\HasMany|Operation[]
     */
    ...
    public function reserveOperation($amount, $currency = BitcoinUtils::CURRENCY_BTC)
    {
        ...
        $operation = DB::transaction(function () use ($amount): void {
            $this->lockForUpdate();
