...
Route::group(['middleware' => 'referral'], function (): void {
...
Route::group(['middleware' => ['web', 'active', 'auth', 'referral']], function (): void {
...
Route::group(['middleware' => ['web', 'active', 'referral']], function (): void {
    Route::get('/', 'HomeController@index');
    Route::get('/catalog', 'CatalogController@index');
    Route::get('/shop/{slug}', 'Shops\ShopsController@shop');
    Route::get('/shop/{slug}/pages/{pageId}', 'Shops\ShopsController@page');
