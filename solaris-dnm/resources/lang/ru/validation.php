...
return [
    ...
    */
    ...
    'not_in_icase' => 'Выбранное значение для :attribute ошибочно.',
    ...
    */
    ...
    'not_starts_with_letter' => 'Поле :attribute не может начинаться с такого символа.',
    'not_starts_with_word' => 'Поле :attribute не может начинаться с таких символов.',
    'pgp_public_key' => 'Формат PGP-ключа неверен.',
    ...
    */
    ...
    'attributes' => [
        ...
        'title' => 'Название',
        'slug' => 'Адрес',
        'percent_amount' => 'Значение в %',
        'discount_mode' => 'Тип скидки',
        'terms' => 'правила магазина',
        'price' => 'стоимость',
        'quests.*.custom_place_title' => 'место',
        'quests.*.quest' => 'описание места',
        'quests.*.employee' => 'сотрудник',
        'packages.*.price' => 'стоимость',
        'packages.*.preorder_time' => 'время',
        'packages.*.currency' => 'валюта',
        'packages.*.measure' => 'единица измерения',
        'text' => 'текст',
        'shop_rating' => 'оценка работы магазина',
        'dropman_rating' => 'оценка работы курьера',
        'item_rating' => 'оценка качества товара',
    ],
