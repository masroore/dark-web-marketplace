...
class CreateNewCategories extends Migration
{
    ...
    public function addChemicalReactives(): void
    {
    ...
    public function addDocuments(): void
    {
    ...
    public function addDigitalGoods(): void
    {
    ...
    public function addTechnics(): void
    {
    ...
    public function addCardsAndBanks(): void
    {
    ...
    public function addGraphicsAndAds(): void
    {
