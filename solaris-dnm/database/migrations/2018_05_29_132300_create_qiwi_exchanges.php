...
class CreateQiwiExchanges extends Migration
{
    ...
    {
        Schema::create('qiwi_exchanges', function (Blueprint $table): void {
            $table->increments('id');
        ...
        Schema::create('qiwi_exchanges_requests', function (Blueprint $table): void {
            $table->increments('id');
        ...
        Schema::create('qiwi_exchanges_transactions', function (Blueprint $table): void {
            $table->increments('id');
