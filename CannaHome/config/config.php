 ...
 */
define('SECURE', false);
define('SITEWIDE_USERNAME_SALT', "☂♄ε η℮ẘ ṧ☂αᾔ∂αя∂\u{a0}☤ᾔ ⅾℯ℮℘\u{a0}ẘεß\u{a0}¢☺μღ℮я¢℮");
define('PROMO_CODE_SALT', "ℐḟ ¥◎ü\u{a0}я℮ⓠυḯґε\u{a0}ƒ◎я¢ε\u{a0}т☺ ℘ґøღ◎тε\u{a0}¥☺υґ ḯ∂εαʟ,\u{a0}⊥♄ℯґℯ\u{a0}☤﹩\u{a0}﹩☺мε⊥нḯηℊ ẘґ☺ηℊ ωḯ☂н ⑂øüґ\u{a0}їⅾεαł");
