...
class Controller
{
    public function __construct($template = false, $logged_in = false, $invite_only = false, $forum = false)
    {
        ...
        $logged_in = $logged_in ?: ($invite_only ? $this->db->invite_only : false);
    ...
    public function checkCSRFToken($token = false): void
    {
