...
class Application
{
    ...
    private function splitUrl()
    {
        if (isset($_GET['url'])) {
            ...
            */
            ...
            $this->url_parameter_4 = ($url[5] ?? null);
    ...
    private function getArgv()
    {
        ...
        if (isset($argv)) {
            $this->url_controller = ($argv[1] ?? null);
            $this->url_action = ($argv[2] ?? null);
            $this->url_parameter_1 = ($argv[3] ?? null);
            $this->url_parameter_2 = ($argv[4] ?? null);
            $this->url_parameter_3 = ($argv[5] ?? null);
            $this->url_parameter_4 = ($argv[6] ?? null);
