...
{
    public const TIMEOUT = ELECTRUM_SERVER_REQUEST_TIMEOUT;
    public const RESPONSE_LENGTH = ELECTRUM_SERVER_REQUEST_RESPONSE_LENGTH;

    public const FEE_ESTIMATES_SATOSHIS_CONVERSION = 1e8;
    public const FEE_ESTIMATES_NEXT_BLOCK_COEFFICIENT = 1.5;
    public const FEE_ESTIMATES_MINIMUM_FEE_SATOSHIS = 10000;
