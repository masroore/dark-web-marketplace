...
class Identifier
{
    public const CLASS_UNIVERSAL = 0x00;
    public const CLASS_APPLICATION = 0x01;
    public const CLASS_CONTEXT_SPECIFIC = 0x02;
    public const CLASS_PRIVATE = 0x03;

    public const EOC = 0x00; // unsupported for now
    public const BOOLEAN = 0x01;
    public const INTEGER = 0x02;
    public const BITSTRING = 0x03;
    public const OCTETSTRING = 0x04;
    public const NULL = 0x05;
    public const OBJECT_IDENTIFIER = 0x06;
    public const OBJECT_DESCRIPTOR = 0x07;
    public const EXTERNAL = 0x08; // unsupported for now
    public const REAL = 0x09; // unsupported for now
    public const ENUMERATED = 0x0A;
    public const EMBEDDED_PDV = 0x0B; // unsupported for now
    public const UTF8_STRING = 0x0C;
    public const RELATIVE_OID = 0x0D;
    // value 0x0E and 0x0F are reserved for future use

    public const SEQUENCE = 0x30;
    public const SET = 0x31;
    public const NUMERIC_STRING = 0x12;
    public const PRINTABLE_STRING = 0x13;
    public const T61_STRING = 0x14; // sometimes referred to as TeletextString
    public const VIDEOTEXT_STRING = 0x15;
    ...
    public const CHARACTER_STRING = 0x1D; // Unrestricted character type
    public const BMP_STRING = 0x1E;

    public const LONG_FORM = 0x1F;
    public const IS_CONSTRUCTED = 0x20;
