...
class OID
{
    ...
    public const MD5_WITH_RSA_ENCRYPTION = '1.2.840.113549.1.1.4';
    public const SHA1_WITH_RSA_SIGNATURE = '1.2.840.113549.1.1.5';
    public const PKCS9_EMAIL = '1.2.840.113549.1.9.1';
    public const PKCS9_UNSTRUCTURED_NAME = '1.2.840.113549.1.9.2';
    public const PKCS9_CONTENT_TYPE = '1.2.840.113549.1.9.3';
    public const PKCS9_MESSAGE_DIGEST = '1.2.840.113549.1.9.4';
    public const PKCS9_SIGNING_TIME = '1.2.840.113549.1.9.5';
    public const PKCS9_EXTENSION_REQUEST = '1.2.840.113549.1.9.14';

    // certificate extension identifier
    public const CERT_EXT_SUBJECT_DIRECTORY_ATTR = '2.5.29.9';
    public const CERT_EXT_SUBJECT_KEY_IDENTIFIER = '2.5.29.14';
    public const CERT_EXT_KEY_USAGE = '2.5.29.15';
    public const CERT_EXT_PRIVATE_KEY_USAGE_PERIOD = '2.5.29.16';
    public const CERT_EXT_SUBJECT_ALT_NAME = '2.5.29.17';
    public const CERT_EXT_ISSUER_ALT_NAME = '2.5.29.18';
    public const CERT_EXT_BASIC_CONSTRAINTS = '2.5.29.19';
    public const CERT_EXT_CRL_NUMBER = '2.5.29.20';
    public const CERT_EXT_REASON_CODE = '2.5.29.21';
    public const CERT_EXT_INVALIDITY_DATE = '2.5.29.24';
    public const CERT_EXT_DELTA_CRL_INDICATOR = '2.5.29.27';
    public const CERT_EXT_ISSUING_DIST_POINT = '2.5.29.28';
    public const CERT_EXT_CERT_ISSUER = '2.5.29.29';
    public const CERT_EXT_NAME_CONSTRAINTS = '2.5.29.30';
    public const CERT_EXT_CRL_DISTRIBUTION_POINTS = '2.5.29.31';
    public const CERT_EXT_CERT_POLICIES = '2.5.29.32';
    public const CERT_EXT_AUTHORITY_KEY_IDENTIFIER = '2.5.29.35';
    public const CERT_EXT_EXTENDED_KEY_USAGE = '2.5.29.37';

    // standard certificate files
    public const COMMON_NAME = '2.5.4.3';
    public const SURNAME = '2.5.4.4';
    public const SERIAL_NUMBER = '2.5.4.5';
    public const COUNTRY_NAME = '2.5.4.6';
    public const LOCALITY_NAME = '2.5.4.7';
    public const STATE_OR_PROVINCE_NAME = '2.5.4.8';
    public const STREET_ADDRESS = '2.5.4.9';
    public const ORGANIZATION_NAME = '2.5.4.10';
    public const OU_NAME = '2.5.4.11';
    public const TITLE = '2.5.4.12';
    public const DESCRIPTION = '2.5.4.13';
    public const POSTAL_ADDRESS = '2.5.4.16';
    public const POSTAL_CODE = '2.5.4.17';
    public const AUTHORITY_REVOCATION_LIST = '2.5.4.38';

    public const AUTHORITY_INFORMATION_ACCESS = '1.3.6.1.5.5.7.1.1';
