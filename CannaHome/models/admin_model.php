...
class admin_model
{
    ...
    public function fetchAnalytics()
    {
        ...
        try {
            ...
            exit('Invalid DB Statements (Aggregate Data): <br><br>' . $this->db->error);
        }
        ...
        foreach ($tabularData as $datum => $query) {
            try {
                ...
                exit('Invalid DB Statements (Tabular Data): "' . $datum . '": <br><br>' . $this->db->error);
            }
        }
    ...
    public function renderAllSalesGraph(): void
    {
    ...
    public function renderStackedGraph(): void
    {
    ...
    public function renderUsersOnlineGraph($weeks = 13): void
    {
    ...
    public function respondApplication($userID): void
    {
        switch ($_POST['action']) {
            case 'approve':
    ...
    private function makeVendor($userID): void
    {
    ...
    private function acknowledgeApplication($userID): void
    {
        $this->db->qQuery(
            '
				UPDATE
    ...
    private function rejectApplication($userID): void
    {
    ...
    private function blacklistApplication($userID): void
    {
        $this->db->qQuery(
            '
				UPDATE
