...
class login_model
{
    ...
    public function login($username = false, $password = false, $prehashed = false, $has_captcha = true)
    {
        if (isset($_POST['username'])) {
            Session::set('login_username', strip_tags($_POST['username']));
        }
        if (isset($_POST['prehashed'])) {
            Session::set('login_prehashed', strip_tags($_POST['prehashed']));
        }
        if (isset($_POST['return'])) {
            Session::set('login_return', $_POST['return']);
        }
    ...
    public function registerNewUser($existingAID = false)
    {
        ...
        if (isset($_POST['invite_code'])) {
            Session::set('login_invite_code', strip_tags($_POST['invite_code']));
        }
        ...
        if (
            ...
            [$s, $a] = $existingAID ?: $this->get_salt_a($username);
    ...
    private function insertAccessCookie(): void
    {
