 ...
 * @property null|Carbon $last_sync_at        Дата последней синхронизации каталога с магазином.
 * @property null|Carbon $created_at          Дата создания записи.
 * @property null|Carbon $updated_at          Дата последнего обновления.
 * @property int         $enabled             Активен(1) или нет(0).
 * @property null|string $image_url_local
 * @property int         $image_cached
 * @property null|string $expires_at
 * @property float       $rating
 * @property null|string $plan
 * @property int         $gate_enabled
 * @property null|string $gate_lan_ip
 * @property null|string $gate_lan_port
...
class Shop extends Model
{
    ...
    public static function available()
    {
        ...
        return self::where('enabled', true) // is applied to catalog
