...
class SetCache extends Command
{
    ...
    private function setGoodsPackages(): void
    {
        (new GoodsPackage())->orderBy('id')->chunk(config('catalog.cache.chunk_size.goods_packages', 1000), function ($goodsPackages): void {
    ...
    private function setGoodsCities(): void
    {
        (new GoodsCity())->orderBy('id')->chunk(config('catalog.cache.chunk_size.goods_cities', 1000), function ($goodsCities): void {
