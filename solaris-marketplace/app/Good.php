 ...
 * @property GoodsPackage[] $packages
 * @property GoodsPosition[] $positions
 * @property City $city
 * @property Shop $shop
...
class Good extends Model
{
    ...
    public static function available()
    {
        ...
        return self::where('image_cached', true)
            ->where('has_quests', true)
            ->whereHas('shop', function ($query) use ($minLastSync): void {
                $query
