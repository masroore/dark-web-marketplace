...
class AdminController extends Controller
{
    ...
    public const ADMIN_CATEGORY_GOODS = 'goods';
    public const ADMIN_CATEGORY_ORDERS = 'orders';
    public const ADMIN_CATEGORY_CATEGORIES = 'categories';
    public const ADMIN_CATEGORY_CITIES = 'cities';
    public const ADMIN_CATEGORY_NEWS = 'news';
    public const ADMIN_CATEGORY_REGIONS = 'regions';
    public const ADMIN_CATEGORY_SHOPS = 'shops';
    public const ADMIN_CATEGORY_USERS = 'users';
    public const ADMIN_CATEGORY_TICKETS = 'ticket';
    public const ADMIN_CATEGORY_ADVSTATS = 'advstats';
    public const ADMIN_CATEGORY_DISPUTES = 'disputes';
    public const ADMIN_CATEGORY_STATS = 'stats';

    public static $redirect_to = '/admin';
